...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		...
		<a href="<?= base_url() ?>TU/ExportExcel" target="blank" class="btn btn-success ml-3 btn-sm d-inline"><i class="fa fa-file-download"> Export Excel </i></a>
	</div>
	<div class="card-body">
			...
			<div class="modal-body">
				<form method="post" action="<?= base_url() ?>TU/Create">
					<div class="form-group">
						...
						<input type="text" class="form-control" required name="nama" placeholder="Masukan nama petugas TU">
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?= base_url() ?>TU/Edit">
					<input type="hidden" required name="id" id="id-TU">
					<div class="form-group">
						<label for="">Nama <span class="text-danger">*</span></label>
						<input type="text" class="form-control" required name="nama" placeholder="Masukan nama TU" id="nama-TU">
					</div>
					<div class="form-group">
						<label for="">Email <span class="text-danger">*</span></label>
						<input type="text" class="form-control" required name="email" placeholder="Masukan Email" id="email-TU">
						<small class="text-danger">* Email Tidak Boleh Sama!</small>
					</div>
					<div class="form-group">
						<label for="">Password <span class="text-danger">*</span></label>
						<input type="text" class="form-control" required name="password" placeholder="Masukan Password" id="password-TU">
					</div>
					<div class="form-group jk-TU">
						<label for="">Jenis Kelamin <span class="text-danger">*</span></label>
						<select class="form-control" id="jk-TU" required name="jk">
							<option disabled selected>-- Jenis Kelamin --</option>
							<option value="Laki-laki">Laki-laki</option>
							<option value="Perempuan">Perempuan</option>
						</select>
					...
					<div class="form-group goldarah-TU">
						<label for="">Gol Darah <span class="text-danger">*</span></label>
						<select class="form-control" id="gol-darah-TU" required name="gol-darah">
							<option disabled selected>-- Gol Darah --</option>
							<option value="A+">A+</option>
							<option value="A-">A-</option>
							<option value="B+">B+</option>
					...
					<div class="form-group">
						<label for="">Pendidikan Terakhir <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="pendidikan-TU" required name="pendidikan" placeholder="CONTOH : S1 PENDIDIKAN SENI RUPA">
					</div>
					<div class="form-group">
						<label for="">Tempat Lahir <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="tempat-lahir-TU" required name="tempat-lahir" placeholder="Masukan Tempat Lahir">
					</div>
					<div class="form-group">
						<label for="">Tanggal Lahir <span class="text-danger">*</span></label>
						<input type="date" class="form-control" id="tanggal-lahir-TU" required name="tanggal-lahir">
						<!-- <input type="date" class="form-control" required name="tanggal-lahir" value="2013-01-08"> -->
					</div>
					<div class="form-group">
						<label for="">Alamat <span class="text-danger">*</span></label>
						<textarea required name="alamat" id="alamat-TU" cols="30" rows="2" class="form-control"></textarea>
					</div>
					<div class="form-group">
						<label for="">Telpon <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="telpon-TU" required name="telpon" placeholder="Masukan Telpon">
					</div>
					<div class="form-group">
						<label for="">kewarganegaraan <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="kewarganegaraan-TU" required name="kewarganegaraan" placeholder="Contoh : Warga Negara Indonesia">
					</div>
					<span class="text-danger">* Wajib diisi!</span>
					<div class="form-group">
